...
const navGroups = computed(() => [
  ...
  },
  {
    ...
    items: [
      { id: 'security', label: t('admin.accountInstruments', 'Gate 账户与合约池'), icon: Wallet },
    ...
    >
      ...
      <div class="px-4 py-3.5 border-b flex items-center justify-between" style="border-color: var(--border-subtle);">
        <div class="flex items-center space-x-2.5">
          ...
          <div>
            <div class="text-xs font-black tracking-wide font-mono" style="color: var(--text-main);">GATE CONTROL</div>
            <button
