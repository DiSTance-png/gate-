          ...
          <tbody>
            ...
            >
              ...
              <td class="py-3 px-4 2xl:px-6 2xl:py-3.5">
                ...
                >
                  <ShieldCheck v-if="pos.displayStop" class="w-3.5 h-3.5 shrink-0" />
                  <ShieldAlert v-else class="w-3.5 h-3.5 shrink-0" />
                  <span class="font-bold font-mono num-tabular">{{ pos.displayStop ? `$${pos.displayStop}` : '未设置' }}</span>
                </div>
              </td>
