    ...
    >
      ...
      >
        ...
        <p class="text-xs font-sans leading-relaxed" style="color: var(--text-muted);">
          {{ isEn ? 'An LLM-native institutional crypto quant workstation for Gate Futures contracts. Powered by differential equations kinematics, multi-agent investment council, exchange-native price protection, and autonomous self-evolution.' : '面向 Gate Futures 永续合约的 LLM 原生量化交易系统。集成高阶微积分物理动能推演、多模型委员会协同决策、Gate 原生计划委托保护单、智能挂单与闭环策略复盘。' }}
        </p>
